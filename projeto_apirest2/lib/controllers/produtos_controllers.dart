...
import 'package:projeto_apirest2/models/produto.dart';
...
class ProdutosController {
  ...
  Future<List<Produto>> getProdutos() async {
    final response = await http.get(Uri.parse('http://10.109.204.31:3000/produtos'));
  ...
  Future<String> postProduto(Produto produto) async {
    final response = await http.post(
        Uri.parse('http://10.109.204.31:3000/produtos'),
